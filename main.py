...
city_1 = input("Wie lautet die erste Stadt?")
city_2 = input("Wie lautet die zweite Stadt?")

url = f'https://www.numbeo.com/cost-of-living/compare_cities.jsp?country1=Germany&country2=Germany&city1={city_1}&city2={city_2}'
